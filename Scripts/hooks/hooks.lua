...
local function CallRequire()
	local path_bak = package.path
	package.path = ".\\Scripts\\modules\\?.lua;.\\Scripts\\modules\\smns\\?.lua"
...
function OnUnitDeath(battle, unit)
end


function OnBattleEnd(winnerGroup)
end

function OnResurrection(battle, unit)
end